...
**Ports:** Each demo uses `PORT` from its `.env`. To run multiple demos at once, set a different `PORT` per demo (e.g. 8006 for symfony6, 8007 for symfony7, 8008 for symfony8) as per the bundle standard protocol.
