 ...
 * }
 * @psalm-type NowoAnonymizeConfig = array{
 *     locale?: scalar|Param|null, // Locale for Faker generator (e.g., en_US, es_ES) // Default: "en_US"
 ...
 *     stats_output_dir?: scalar|Param|null, // Directory where statistics exports will be saved (JSON/CSV) // Default: "%kernel.project_dir%/var/stats"
 *     history_dir?: scalar|Param|null, // Directory where anonymization history will be stored // Default: "%kernel.project_dir%/var/anonymize_history"
 *     export?: bool|array{ // Database export configuration
 *         enabled?: bool|Param, // Default: false
 *         output_dir?: scalar|Param|null, // Directory where database exports will be saved // Default: "%kernel.project_dir%/var/exports"
 *         filename_pattern?: scalar|Param|null, // Filename pattern for exports. Available placeholders: {connection}, {database}, {date}, {time}, {format} // Default: "{connection}_{database}_{date}_{time}.{format}"
 ...
 *     },
 *     hash_preserve?: array{ // Defaults for HashPreserveFaker (deterministic hashing with optional salt)
 *         default_salt?: scalar|Param|null, // Salt applied when faker options omit salt. Null uses %%kernel.secret%%. // Default: null
 *     },
 ...
 *         nowo_anonymize?: NowoAnonymizeConfig,
