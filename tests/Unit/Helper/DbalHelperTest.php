...
class DbalHelperTest extends TestCase
{
     ...
     * When driver has getName(), it is used; otherwise params/platform fallback is used.
     */
    ...
    /**
     * Test getDriverName when driver implements getName() (DBAL 2.x path).
     * When the Driver instance has getName(), it is used (covers line 95-96 in DbalHelper).
     */
    public function testGetDriverNameUsesDriverGetNameWhenAvailable(): void
    {
        $driver = new DriverStubWithGetName();
    ...
    /**
     * Test quoteIdentifier uses connection quoteSingleIdentifier when getDatabasePlatform throws.
     */
    public function testQuoteIdentifierWhenGetDatabasePlatformThrows(): void
    {
        $connection = $this->createMock(Connection::class);
...
/**
 * Stub Driver that implements getName() (DBAL 2.x style) for coverage of getDriverName branch.
 *
 * @internal
 */
final class DriverStubWithGetName implements Driver
{
