...
class CopyFakerTest extends TestCase
{
    ...
    /**
     * Test that CopyFaker finds field via strtolower when record key is lowercase and source_field is uppercase.
     */
    public function testGenerateFindsFieldViaStrtolower(): void
    {
        $faker  = new CopyFaker();
        $record = ['email' => 'lower@test.com'];
        ...
        $this->assertSame('lower@test.com', $result);
    }

    /**
     * Test that CopyFaker finds field via strtoupper when record key is uppercase and source_field is lowercase.
     */
    public function testGenerateFindsFieldViaStrtoupper(): void
    {
        $faker  = new CopyFaker();
        $record = ['EMAIL' => 'upper@test.com'];
        ...
        $this->assertSame('upper@test.com', $result);
    }

    /**
     * Test that CopyFaker finds field via ucfirst when record key is ucfirst and source_field is lowercase.
     */
    public function testGenerateFindsFieldViaUcfirst(): void
    {
        $faker  = new CopyFaker();
        $record = ['Mail' => 'ucfirst@test.com'];
        ...
        $this->assertSame('ucfirst@test.com', $result);
    }

    /**
     * Test that CopyFaker uses fallback when field is not in record (no exact, lower, upper, ucfirst match).
     */
    public function testGenerateUsesFallbackWhenFieldNotFoundInRecord(): void
    {
        $faker  = new CopyFaker();
        $record = ['other' => 'value'];
