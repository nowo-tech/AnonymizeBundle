...
class NameFallbackFakerTest extends TestCase
{
    ...
    /**
     * Test that NameFallbackFaker respects locale_specific false (uses generic firstName).
     */
    ...
    /**
     * Test that NameFallbackFaker respects gender female.
     */
    ...
    /**
     * Test that NameFallbackFaker uses default (random) when gender is unknown.
     */
    public function testGenerateWithGenderDefault(): void
    {
        $faker = new NameFallbackFaker('en_US');
        $name  = $faker->generate([
            'original_value' => 'Alex',
