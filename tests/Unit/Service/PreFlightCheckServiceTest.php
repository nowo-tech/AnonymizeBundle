...
class PreFlightCheckServiceTest extends TestCase
{
    ...
    /**
     * Test that when FakerFactory::create() throws, the error is reported.
     */
    public function testFakerFactoryCreateExceptionIsReported(): void
    {
        ...
        $service = new PreFlightCheckService($fakerFactory);
    ...
    /**
     * Test that validatePatterns detects invalid include pattern when field is negative integer.
     */
    public function testValidatePatternsDetectsInvalidIncludePatternWithNegativeIntegerField(): void
    {
        $em            = $this->createMock(EntityManagerInterface::class);
        $connection    = $this->createMock(Connection::class);
        $schemaManager = $this->createMock(AbstractSchemaManager::class);
    ...
    /**
     * Test that validateFakerType skips faker creation for type "service" (service fakers need container).
     */
    public function testValidateFakerTypeSkipsCreationForServiceTypeWhenServiceNameSet(): void
    {
        $em            = $this->createMock(EntityManagerInterface::class);
        $connection    = $this->createMock(Connection::class);
        $schemaManager = $this->createMock(AbstractSchemaManager::class);
    ...
    /**
     * Test that isListOfPatternSets returns false when list contains a non-array item (covers return false branch).
     */
    public function testValidatePatternsListOfConfigsWithNonArrayItem(): void
    {
        $em            = $this->createMock(EntityManagerInterface::class);
        $connection    = $this->createMock(Connection::class);
        $schemaManager = $this->createMock(AbstractSchemaManager::class);
    ...
    /**
     * Test that validateOnePatternEntry returns error when field is not string and not int (e.g. float).
     * Covers the branch "Invalid include pattern: field must be string".
     */
    ...
    /**
     * Test that validatePatterns (list of configs) reports error with config #2 when second set has invalid pattern.
     */
    public function testValidatePatternsDetectsInvalidPatternInSecondConfig(): void
    {
        $em            = $this->createMock(EntityManagerInterface::class);
        $connection    = $this->createMock(Connection::class);
        $schemaManager = $this->createMock(AbstractSchemaManager::class);
    ...
    /**
     * Test that checkColumnExistence catches exception when listTableColumns throws (e.g. schema not available).
     * Covers the catch block that swallows the exception and does not fail the check.
     */
    public function testCheckColumnExistenceCatchesExceptionWhenListTableColumnsThrows(): void
    {
        $em            = $this->createMock(EntityManagerInterface::class);
        $connection    = $this->createMock(Connection::class);
        $schemaManager = $this->createMock(AbstractSchemaManager::class);
