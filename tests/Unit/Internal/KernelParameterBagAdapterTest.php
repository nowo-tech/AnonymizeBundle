...
namespace Nowo\AnonymizeBundle\Tests\Unit\Internal;
...
class KernelParameterBagAdapterTest extends TestCase
{
    ...
    /**
     * Test get() returns value when container has hasParameter and getParameter (prefer container parameters).
     * Symfony's Container extends Psr ContainerInterface and adds hasParameter/getParameter.
     */
    public function testGetReturnsValueViaContainerHasParameterAndGetParameter(): void
    {
        $container = $this->createMock(\Symfony\Component\DependencyInjection\ContainerInterface::class);
        $container->method('hasParameter')
            ->with('nowo_anonymize.locale')
            ->willReturn(true);
