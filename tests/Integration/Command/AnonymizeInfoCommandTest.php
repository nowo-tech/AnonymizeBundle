...
class AnonymizeInfoCommandTest extends TestCase
{
    ...
    {
        $command = new AnonymizeInfoCommand($this->createDefaultAnonymizeService(), new PatternMatcher(), $this->createSafeEnvironmentProtection(), $this->createMock(ManagerRegistry::class), 'en_US', []);
    ...
    public function testCommandReturnsFailureWhenNoEntityManagers(): void
    {
        ...
        $command = new AnonymizeInfoCommand($this->createDefaultAnonymizeService(), new PatternMatcher(), $this->createSafeEnvironmentProtection(), $doctrine, 'en_US', []);
    ...
    {
        $command = new AnonymizeInfoCommand($this->createDefaultAnonymizeService(), new PatternMatcher(), $this->createSafeEnvironmentProtection(), $this->createMock(ManagerRegistry::class), 'es_ES', []);
    ...
    {
        $command = new AnonymizeInfoCommand($this->createDefaultAnonymizeService(), new PatternMatcher(), $this->createSafeEnvironmentProtection(), $this->createMock(ManagerRegistry::class), 'en_US', ['default', 'postgres']);
    ...
    public function testExecuteFailsWhenEnvironmentProtectionBlocks(): void
    {
        ...
        $command = new AnonymizeInfoCommand($this->createDefaultAnonymizeService(), new PatternMatcher(), $protection, $this->createMock(ManagerRegistry::class));
        $input   = new ArrayInput([]);
        $output  = new BufferedOutput();
    ...
    private function createDefaultAnonymizeService(): AnonymizeService
    {
        return new AnonymizeService(new FakerFactory('en_US'), new PatternMatcher());
    }
