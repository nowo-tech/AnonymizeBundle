...
class DatabaseExportServiceTest extends TestCase
{
    ...
    /**
     * Test that DatabaseExportService can be instantiated with the default filename pattern.
     */
    ...
    public function testExportMySQLUsesCommandRunnerAndReturnsDumpPath(): void
    {
        ...
        $this->assertStringContainsString('mysqldump content', $content);
    }
    ...
    public function testExportPostgreSQLUsesCommandRunnerAndReturnsDumpPath(): void
    {
        ...
        $content = file_get_contents($result);
        $this->assertIsString($content);
        $this->assertStringContainsString('pg_dump content', $content);
    }
